...
# Helper code
def p5_run_particle_filter(filter_class, imgs_dir, template_rect,
                        save_frames={}, **kwargs):
...
def part_4():
    ...
    num_particles = 50 # Define the number of particles
    sigma_md = 15 # Define the value of sigma for the measurement exponential equation
    sigma_dyn = 2.3 # Define the value of sigma for the particles movement (dynamics)
    sigma_scale = 0.01
    ...
    run_particle_filter(ps5.MDParticleFilter,
                        ...
                        sigma_dyn=sigma_dyn, alpha=alpha,sigma_scale=sigma_scale,
                        template_coords=template_rect)  # Add more if you need to
...
def part_5():
    ...
    # person one
    template_rect = {'x': 55, 'y':150, 'w': 90, 'h': 285}
    # person two
    #template_rect = {'x': 295, 'y':190, 'w': 55, 'h': 200}
    ...
    sigma_dyn = 20 # Define the value of sigma for the particles movement (dynamics)
    '''
    p5_run_particle_filter(ps5.MTParticleFilter,
...
def part_6():
    ...
    """
    # person one
    template_rect = {'x': 70, 'y':40, 'w': 60, 'h': 70}
    # person two
    #template_rect = {'x': 295, 'y':190, 'w': 55, 'h': 200}
    save_frames = {59: os.path.join(output_dir, 'ps5-6-a-1.png'),
