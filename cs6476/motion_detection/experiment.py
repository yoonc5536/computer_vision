...
def part_1a():
    ...
    shift_r2_blur = cv2.GaussianBlur(shift_r2, gkernel, gsigma)
    Shift_r5_u5_blur = cv2.GaussianBlur(shift_r5_u5, gkernel, gsigma)
    k_type = "uniform"
    sigma = 1

    k_size = 21
    u, v = ps4.optic_flow_lk(shift_0_blur, shift_r2_blur, k_size, k_type, sigma)
    # Flow image
...
def part_4b():
    ...
    levels = 100  # TODO: Define the number of levels
